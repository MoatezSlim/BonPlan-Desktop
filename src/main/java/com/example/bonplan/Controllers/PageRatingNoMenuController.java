...
public class PageRatingNoMenuController implements Initializable {
    ...
    private AnchorPane createRatingPane(Ratings rating) {
        ...
        if (rating == null) {
            ...
            float rate = rating.getRate_bp();
            String imagePath;
            switch ((int) rate) {
                case 5:
                    imagePath = "/com/example/bonplan/Images/5stars.jpg";
                    break;
                case 4:
                    imagePath = "/com/example/bonplan/Images/4stars.jpg";
                    break;
                case 3:
                    imagePath = "/com/example/bonplan/Images/3stars.jpg";
                    break;
                default:
                    imagePath = "/com/example/bonplan/Images/rating.png";
                    break;
            }
            imageViewRating.setImage(new Image(Objects.requireNonNull(getClass().getResourceAsStream(imagePath))));
